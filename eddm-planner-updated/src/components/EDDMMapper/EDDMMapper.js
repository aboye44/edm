    ...
    try {
      ...
      if (mapContainer && mapRef.current) {
        try {
          ...
          // Fit map to selected routes bounds
          ...
          mapRef.current.setCenter(originalCenter);
      ...
      doc.text('Generated by MPA EDDM Campaign Planner | eddm.mailpro.org', 20, pageHeight - 15);
